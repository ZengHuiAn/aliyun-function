...
var Client = function () {
  ...
  _createClass(Client, [{
    ...
    value: function createService(serviceName) {
      ...
      console.log("createService",headers);
    ...
    value: function getFunction(serviceName, functionName) {
      ...
      var headers = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
      var qualifier = arguments[3];
      const path = `/services/${getServiceName(serviceName, qualifier)}/${functionName}`
      return this.get(`/services/${getServiceName(serviceName, qualifier)}/${functionName}`, null, headers);
    }
